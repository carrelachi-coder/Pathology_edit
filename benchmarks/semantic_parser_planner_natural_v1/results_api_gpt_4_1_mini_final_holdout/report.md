...
This run evaluated **87** catalog-derived Chinese and English instructions with parser mode **api**.

本次运行使用 **api** 模式，评估了 **87** 条由 ontology 与 primitive catalog 派生的中英文指令。
...
|---|---:|---:|---:|---:|
| en | 44 | 100.00% | 100.00% | 100.00% |
| zh | 43 | 100.00% | 100.00% | 100.00% |

## Breakdown by case type / 按测试类型分层

| Category | n | Semantic exact | Planner exact |
|---|---:|---:|---:|
| `catalog_single_intent` | 70 | 100.00% | 100.00% |
| `negation` | 4 | 100.00% | 100.00% |
| `ordered_multi_intent` | 6 | 100.00% | 100.00% |
| `underspecified_intent` | 3 | 100.00% | 100.00% |
| `unordered_conflict` | 4 | 100.00% | 100.00% |
