...
6. Permit treatment-associated fibrotic replacement only for an explicit post-treatment scenario, an existing Pattern-5 Tumor--Stroma interface, and a candidate that preserves every Pattern-3/4 pixel. Never infer patient treatment history from H&E.
