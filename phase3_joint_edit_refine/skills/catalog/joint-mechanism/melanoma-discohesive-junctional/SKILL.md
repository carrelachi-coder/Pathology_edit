---
name: melanoma-discohesive-junctional
description: Joint tissue–cell execution contract for melanoma discohesive junctional; use only after the required H&E, label-profile, native-structure and nuclei observations are available.
---
