---
name: lung-solid-squamous-growth
description: Joint tissue–cell execution contract for lung solid squamous growth; use only after the required H&E, label-profile, native-structure and nuclei observations are available.
---
