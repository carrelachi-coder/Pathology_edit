...
description: Joint tissue–cell execution contract for prostate pattern 5 growth; use only after the required H&E, label-profile, native-structure and nuclei observations are available.
---
