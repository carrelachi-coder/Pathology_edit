---
name: prostate-pattern-5-growth
description: Joint tissue–cell execution contract for prostate pattern 5 growth; use only after the required mask-profile, native-structure, nuclei, and certified-candidate observations are available.
---
