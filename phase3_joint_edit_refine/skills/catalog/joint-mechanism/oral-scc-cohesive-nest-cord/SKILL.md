---
name: oral-scc-cohesive-nest-cord
description: Joint tissue–cell execution contract for oral scc cohesive nest cord; use only after the required H&E, label-profile, native-structure and nuclei observations are available.
---
