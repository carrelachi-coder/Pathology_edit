---
name: melanoma-cohesive-nest-sheet
description: Joint tissue–cell execution contract for melanoma cohesive nest sheet; use only after the required H&E, label-profile, native-structure and nuclei observations are available.
---
