---
name: oral-scc-dispersed-invasive-front
description: Joint tissue–cell execution contract for oral scc dispersed invasive front; use only after the required H&E, label-profile, native-structure and nuclei observations are available.
---
