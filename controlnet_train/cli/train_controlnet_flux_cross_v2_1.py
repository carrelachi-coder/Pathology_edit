"""Train Phase 5.3 Cross V2.1 Flux ControlNet."""
...
def parse_args(input_args=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Train Phase 5.3 Cross V2.1 Flux ControlNet with condition order "
    ...
    parser.add_argument("--output-dir", type=str, default="phase5-controlnet-cross-v2-1")
    ...
    parser.add_argument("--tracker-project-name", type=str, default="flux_controlnet_phase5_cross_v2_1")
    ...
    parser.add_argument("--cross-version", type=str, default="v2.1")
