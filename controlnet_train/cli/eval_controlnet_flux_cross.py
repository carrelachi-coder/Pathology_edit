"""Evaluate a Phase 5 FLUX cross ControlNet on cross-reconstruction metadata."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Evaluate Phase 5 FLUX cross ControlNet.")
...
def main(argv=None) -> int:
    ...
    from controlnet_train.inference import load_cross_bundle, run_cross_v0_bundle
    ...
    for index, record in enumerate(records):
        ...
        with torch.no_grad():
            prediction = run_cross_v0_bundle(bundle, inputs, prompt)
