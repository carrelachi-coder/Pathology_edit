...
# Reference-aware auxiliary losses. These defaults intentionally push the IP
# path to use concrete reference stain/style information.
REFERENCE_STYLE_LOSS_WEIGHT="${REFERENCE_STYLE_LOSS_WEIGHT:-50}"
...
REF_SWAP_LOSS_WEIGHT="${REF_SWAP_LOSS_WEIGHT:-0.5}"
...
SELF_RECONSTRUCTION_L1_WEIGHT="${SELF_RECONSTRUCTION_L1_WEIGHT:-1.0}"
