...
# reference projection with pure denoise loss. HED/stain/texture degradation is
# opt-in so the current reference-path health checks stay attributable.
...
CROSS_V1_OUTPUT_DIR="${CROSS_V1_OUTPUT_DIR:-/data/wqx/flowedit/controlnet_cross_v1_regional_ip_66k_pure_denoise_spatial_nobias}"
...
REGIONAL_IP_LABEL_MODE="${REGIONAL_IP_LABEL_MODE:-tissue-nuclei}"
A1_LITE="${A1_LITE:-1}"
...
REFERENCE_REGION_LOSS_WEIGHT="${REFERENCE_REGION_LOSS_WEIGHT:-0}"
