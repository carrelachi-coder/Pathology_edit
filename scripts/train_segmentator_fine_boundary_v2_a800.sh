...
OUTPUT_DIR="${OUTPUT_DIR:-/data1/zhao/wqx/segmentator_fine/fine_boundary_v2_seed42}"
...
TRAIN_ARGS=(
  ...
  --checkpoint-coarse-miou-floor 0.6140
...
echo "Launching Fine Boundary V2 on GPUs $GPU_IDS (world_size=$NUM_GPUS)"
if (( NUM_GPUS > 1 )); then
