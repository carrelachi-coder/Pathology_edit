...
| Tissue evaluator | C-line joint epoch 2 | Release `segmentator-fine-c-joint-epoch2-v1`, strict architecture reconstruction, image-only runtime. |
...
The default local paths point at the packaged server releases. Environment
variables are the supported deployment override; editing source constants on a
