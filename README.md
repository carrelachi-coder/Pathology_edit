...
完整发布验收包括：Hub 文件 SHA256 对齐、三个仓库 private 状态、Inpaint 固定样本、Cross V1 + Pix2pix 像素一致性，以及 ProbNet 配合本地实例库生成 mask。详细结果记录在 [docs/generation_model_release.md](docs/generation_model_release.md)。
